...
from datadog_mcp.tools.logs import search_logs as _search_logs, get_log_details as _get_log_details
from datadog_mcp.tools.metrics import query_metrics as _query_metrics, list_metrics as _list_metrics, submit_metrics as _submit_metrics
from datadog_mcp.tools.dashboards import (
    list_dashboards as _list_dashboards, get_dashboard as _get_dashboard, create_dashboard as _create_dashboard, 
    update_dashboard as _update_dashboard, delete_dashboard as _delete_dashboard
)
from datadog_mcp.tools.apm import search_spans as _search_spans, get_trace as _get_trace, list_services as _list_services
from datadog_mcp.tools.monitors import (
    list_monitors as _list_monitors, get_monitor as _get_monitor, create_monitor as _create_monitor,
    update_monitor as _update_monitor, delete_monitor as _delete_monitor, mute_monitor as _mute_monitor, unmute_monitor as _unmute_monitor
)
from datadog_mcp.tools.aggregations import (
    count_logs as _count_logs,
    count_unique as _count_unique,
    aggregate_logs as _aggregate_logs
)
...
_auth_instance: Optional[DatadogAuth] = None
...
def search_logs(
    ...
    """
    return _search_logs(query, from_time, to_time, page_size, cursor, sort, indexes, auth=get_auth_instance())
...
def aggregate_logs_by_field(
    ...
    """
    return _aggregate_logs(query, from_time, to_time, group_by, aggregation, metric, limit, indexes, auth=get_auth_instance())
...
@mcp.tool()
def list_available_metrics(filter: Optional[str] = None, limit: int = 100) -> dict:
...
@mcp.tool()
def list_all_dashboards(filter_query: Optional[str] = None, limit: int = 100) -> dict:
...
def create_new_dashboard(
    ...
    """
    auth = get_auth_instance()
    return _create_dashboard(title, layout_type, widgets, description, 
                           template_variables, notify_list, tags, auth=auth)
...
def update_existing_dashboard(
    ...
    """
    auth = get_auth_instance()
    return _update_dashboard(dashboard_id, title, widgets, description,
                           template_variables, layout_type, notify_list, tags, auth=auth)
...
@mcp.tool()
def list_apm_services(env: Optional[str] = None, limit: int = 100) -> dict:
...
@mcp.tool()
def unsilence_monitor(monitor_id: int, scope: Optional[str] = None) -> dict:
