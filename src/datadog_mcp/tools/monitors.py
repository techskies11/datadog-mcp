        ...
        if response:
            for monitor in response[:limit]:
                monitor_entry = {
                    ...
                    if hasattr(monitor, "created") and monitor.created
                    else None,
                    "modified": monitor.modified.isoformat()
                    if hasattr(monitor, "modified") and monitor.modified
                    else None,
...
def get_monitor(monitor_id: int, auth: DatadogAuth | None = None) -> dict:
    ...
    try:
        ...
        return {"success": True, "monitor": monitor_dict}
...
def update_monitor(
    ...
    try:
        ...
        body = Monitor(**monitor_data)
        response = api_instance.update_monitor(monitor_id, body=body)  # type: ignore[arg-type]
...
def mute_monitor(
    ...
    try:
        ...
        body = kwargs
        api_instance.mute_monitor(monitor_id, body=body)  # type: ignore[attr-defined]
...
def unmute_monitor(
    monitor_id: int, scope: str | None = None, auth: DatadogAuth | None = None
) -> dict:
    ...
    try:
        ...
        body = kwargs
        api_instance.unmute_monitor(monitor_id, body=body)  # type: ignore[attr-defined]
